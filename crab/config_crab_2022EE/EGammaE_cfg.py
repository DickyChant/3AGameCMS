...
config.JobType.scriptExe = '2022EE_script/crab_script_dataE.sh'
...
config.Data.inputDataset = '/EGamma/Run2022E-22Sep2023-v1/NANOAOD'
...
config.Data.outputDatasetTag = 'EGamma_E'
