#!/usr/bin/env python
"""
JME corrections helper for Run2 (2016/2017/2018)

IMPORTANT: CVMFS Alternative Available
========================================
The JEC/JER corrections used below are also available via CVMFS using correctionlib JSON format at:
- 2016 preVFP: /cvmfs/cms-griddata.cern.ch/cat/metadata/JME/Run2-2016preVFP-UL-NanoAODv9/latest/jet_jerc.json.gz
- 2016 postVFP: /cvmfs/cms-griddata.cern.ch/cat/metadata/JME/Run2-2016postVFP-UL-NanoAODv9/latest/jet_jerc.json.gz
- 2017 UL: /cvmfs/cms-griddata.cern.ch/cat/metadata/JME/Run2-2017-UL-NanoAODv9/latest/jet_jerc.json.gz
- 2018 UL: /cvmfs/cms-griddata.cern.ch/cat/metadata/JME/Run2-2018-UL-NanoAODv9/latest/jet_jerc.json.gz

These CVMFS files contain all JEC/JER corrections in correctionlib format, which is the recommended
approach for Run3 and later. To use CVMFS-based corrections, the jetmetUncertainties module would
need to be updated to support correctionlib. For now, this helper continues to use the tar.gz approach.

Example CVMFS correction names (from jet_jerc.json.gz):
