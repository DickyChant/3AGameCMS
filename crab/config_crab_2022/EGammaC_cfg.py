...
config.JobType.scriptExe = '2022_script/crab_script_dataC.sh'
...
config.Data.inputDataset = '/EGamma/Run2022C-22Sep2023-v1/NANOAOD'
...
config.Data.outputDatasetTag = 'EGamma_C'
