...
config.JobType.scriptExe = '2022EE_script/crab_script_dataF.sh'
...
config.Data.inputDataset = '/EGamma/Run2022F-22Sep2023-v2/NANOAOD'
...
config.Data.outputDatasetTag = 'EGamma_F'
